...
import { veiculosApi, estadosApi } from '@/services/api'
...
export default function VeiculosPage() {
  ...
  const estadoLabel = estadoSelecionado ? `${estadoSelecionado.uf}` : ''
    ...
    <div>
      ...
      <Modal wide open={open} title={editing ? 'Editar Veículo' : 'Novo Veículo'} editing={editing}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          {/* Linha 1: Placa + ANTT + Ativo */}
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-end' }}>
            <div style={{ display: 'flex', gap: 12, alignItems: 'flex-end', marginBottom: 14 }}>
              <div style={{ flex: '0 0 30px' }}>
                <FField label="Código" value={editing ? String(form.codVeic ?? '') : '—'} onChange={() => { }} />
              </div>
